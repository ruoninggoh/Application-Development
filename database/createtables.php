...
$sql = "INSERT INTO user (userID, username, email, password, role) VALUES 
        (1, 'staff', 'staff@graduate.utm.my', '$hashedPassword', 'Staff'), 
        (2, 'doctor', 'doctor@graduate.utm.my', '$hashedPassword1', 'Doctor'), 
        (3, 'jiauting','jiauting@graduate.utm.my', '$hashedPassword2', 'Patient')";
