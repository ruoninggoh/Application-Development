...
<div class = 'form-group mt-3'>
<label id = 'subject'  style="width: 9%;color: #495057;">Subject:</label>
<select name = 'subject' id = 'subject' style="color:#495057;border-radius: 0.25rem;padding:0.375rem 0.75rem;font-size:1rem;line-height: 1.5;color: #495057;border: 1px solid #ced4da;width: 90%;">
<option value = 'General Inquiry'>General Inquiry</option>
<option value = 'Feedback Inquiry'>Feedback Inquiry</option>
</select>
</div>
<div class = 'form-group mt-3'>
